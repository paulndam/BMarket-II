...
import { deliveredOrder, detailsOrder, payOrder } from "../Actions/OrderAction";
...
const OrderScreen = (props) => {
  ...
  const orderDeliveredReducer = useSelector(
    (state) => state.orderDeliveredReducer
  );
  const {
  ...
  //   useEffect method to send request to backend for paypal data information
  useEffect(() => {
          ...
          <table>
            ...
            {UserInfo.isAdmin && Order.isPaid && !Order.isDelivered && (
              <div>
                ...
                {errorDelivered && <MessageBox variant='danger' >{errorDelivered}</MessageBox>}
