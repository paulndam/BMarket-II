...
import { saveLatestPShipping } from "../Actions/LatestCartAction";

const ShippingLatestProductScreen = (props) => {
        ...
        <div className="col-2">
          <div className="form-container shipping-form">
            <form className="form" onSubmit={submitHandler}>
              ...
              <div>
                <label>
                  <button className="btn" type="button" onClick={chooseOnMap}>
                    {" "}
...
export default ShippingLatestProductScreen;
